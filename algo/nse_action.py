...
def place_regular_buy_order_ENT(kite_conn_var,symbol, nse_p, zerodha_flag_obj):
  # Place an order
  quantity  = 1
  order_id  = 0
  ...
  return order_id, order_status, nse_p, quantity

def place_regular_sell_order_ENT(kite_conn_var,symbol, nse_p, zerodha_flag_obj):
  # Place an order
  quantity  = 1
  order_id  = 0
  order_status = 'NOT_PLACED'
